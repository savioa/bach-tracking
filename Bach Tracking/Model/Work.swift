...
class Work: Identifiable {
    ...
    enum Tonality: String, CaseIterable, Identifiable, Codable {
        ...
        case dFlatMajor = "Dó sustenido/Ré bemol maior"
        case dMajor = "Ré maior"
        case eFlatMajor = "Ré sustenido/Mi bemol maior"
        case ebMajor = "Mi maior"
        case fMajor = "Fá maior"
        case fSharpMajor = "Fá sustenido/Sol bemol maior"
        case gMajor = "Sol maior"
        case aFlatMajor = "Sol sustenido/Lá bemol maior"
        case aMajor = "Lá maior"
        case bFlatMajor = "Lá sustenido/Si bemol maior"
        case bMajor = "Si maior"

        case cMinor = "Dó menor"
        case cSharpMinor = "Dó sustenido/Ré bemol menor"
        case dMinor = "Ré menor"
        case dSharpMinor = "Ré sustenido/Mi bemol menor"
        case eMinor = "Mi menor"
        case fMinor = "Fá menor"
        case fSharpMinor = "Fá sustenido/Sol bemol menor"
        case gMinor = "Sol menor"
        case aFlatMinor = "Sol sustenido/Lá bemol menor"
        case aMinor = "Lá menor"
        case bFlatMinor = "La sustenido/Si bemol menor"
